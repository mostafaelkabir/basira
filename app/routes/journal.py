...
def _serialize(e: JournalEntry):
    return {
        ...
        "energy": e.energy,
        "body": e.body,
        "body_original": getattr(e, 'body_original', None),
        "wins": e.wins,
        "wins_original": getattr(e, 'wins_original', None),
        "improve": e.improve,
        "improve_original": getattr(e, 'improve_original', None),
        "gratitude": e.gratitude,
        "gratitude_original": getattr(e, 'gratitude_original', None),
